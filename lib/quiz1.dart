...
class AnimalQuiz{
  ...
  var choices = [
    ...
    ["Shawon", "Eamin", "Shagor", "Jakaria"],
  ];


  var correctAnswers = [
    "Alligator", "Cat", "Dog", "Owl","Shawon",
  ];
}
  ...
  void updateQuestion(){
    setState(() {
      if(questionNumber == quiz.questions.length - 1){
        var finalscore;
        Navigator.push(context, new MaterialPageRoute(builder: (context)=> Summary(score: finalScore, key: finalscore,)));
...
class Summary extends StatelessWidget{
  final int score;
  Summary({required Key key, required this.score}) : super(key: key);
